		...
		<CardTitle>
			...
			>
				<svg xmlns="http://www.w3.org/2000/svg"  fill="none" viewBox="0 0 24 24" stroke="currentColor">
					<path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13.828 10.172a4 4 0 010 5.656l-3.535 3.535a4 4 0 01-5.657-5.657l1.414-1.414m6.364-6.364a4 4 0 015.657 5.657l-1.414 1.414" />
				</svg>
			</a>
		</CardTitle>
	</CardHeader>
...
const StadtLandPlus = <Card>
	...
	<CardDescription>
		Developed a real-time multiplayer game using React, Node.js, and Socket.io, allowing players to compete in a
